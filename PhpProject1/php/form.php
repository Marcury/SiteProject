                        ...
                        <form action="register.php" method="POST" id="register-form">
                            <fieldset>
                                <dl>
                                    ...
                                    <dd><input type="text" name="login" id="nick" placeholder="Nick" pattern="[a-zA-Z0-9]{5,20}" required title="Od 5 do 20 znaków. Polskie znaki nie są dozwolone."></dd>
                                    <dt><label for="password">Hasło:</label></dt>
                                    <dd><input type="password" name="password" id="password" placeholer="hasło" pattern="[a-zA-Z0-9]{5,20}" required title="Od 5 do 20 znaków. Polskie znaki nie są dozwolone."></dd>
                                    <dt><label for="email">E-mail:</label></dt>
                                    <dd><input type="text" name="email" placeholder="mail@domena.pl" id="email" pattern="\b[A-Z0-9._%+-]+\@[A-Z0-9.-]\+\.[A-Z]{2,4}\b" required title="E-mail w formacie: mail@domena.pl"></dd>
