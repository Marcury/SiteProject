                ...
                <div class="col-2">
                    ...
                    <div class="table-border">
                        ...
                        if (isset($_SESSION['nick']) && isset($_SESSION['ip'])) {
                                ...
                                // sprawdzam czy id jest poprawne i ustawione
                            if (isset($_GET['id']) && is_numeric($_GET['id'])) {
                                $id = $_GET['id'];
                                    
                                //wywołanie funkcji, która usunie rekord
                                $bd = new wiadomosciDB('', '', '', '', "localhost", "root", "", "wiadomosci");
                               $bd->usun($id);
                                    //wracamy do podglądu
                                header("Location: userpanel.php?Wyswietl=Wyświetl");
                            } else {
                                      // jeśli nie ustawione albo nie poprawne wracamy do widoku
                                header("Location: userpanel.php?Wyswietl=Wyświetl");
                            }
